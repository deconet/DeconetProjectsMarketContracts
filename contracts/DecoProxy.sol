...
contract DecoProxy {
    ...
    /**
     * @dev Forward transaction to the destination address.
    ...
    /**
     * @dev Withdraw given amount of wei to the owner's address.
     ...
     */
    function withdrawERC20Token(address _tokenAddress, uint _tokens) public {
        IERC20 token = IERC20(_tokenAddress);
        require(token.transfer(owner, _tokens), "Tokens transfer must complete successfully.");
    }
}
